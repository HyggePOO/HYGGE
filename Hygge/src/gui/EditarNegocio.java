...
public class EditarNegocio extends JFrame {
	...
	public EditarNegocio(final Negocio negocio) {
		...
		botonSubirArchivo2.setBounds(631, 257, 75, 23);
		...
		botonSubirArchivo3.setBounds(631, 277, 75, 23);
		...
		botonSubirArchivo4.setBounds(716, 257, 75, 23);
		...
		botonSubirArchivo5.setBounds(716, 277, 75, 23);
		...
		btnNewButton.setBounds(701, 22, 89, 23);
		...
		botonGuardarImg2.setFont(new Font("Tahoma", Font.PLAIN, 6));
		...
		botonGuardarImg2.setBounds(631, 311, 75, 23);
		contentPane.add(botonGuardarImg2);
		
		JButton botonGuardarImg3 = new JButton("Guardar Im\u00E1gen");
		botonGuardarImg3.setFont(new Font("Tahoma", Font.PLAIN, 6));
		...
		botonGuardarImg3.setBounds(631, 335, 75, 23);
		contentPane.add(botonGuardarImg3);
		
		JButton botonGuardarImg4 = new JButton("Guardar Im\u00E1gen");
		botonGuardarImg4.setFont(new Font("Tahoma", Font.PLAIN, 6));
		...
		botonGuardarImg4.setBounds(716, 311, 75, 23);
		contentPane.add(botonGuardarImg4);
		
		JButton botonGuardarImg5 = new JButton("Guardar Im\u00E1gen");
		botonGuardarImg5.setFont(new Font("Tahoma", Font.PLAIN, 6));
		...
		botonGuardarImg5.setBounds(716, 335, 75, 23);
