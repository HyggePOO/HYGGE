...
public class Regiones {
	...
	private static String clasificador(String ciudad) {
		...
		}if(ciudad.toLowerCase().equals("bogota") || ciudad.toLowerCase().equals("bogotá")) {
			return "Bogotá DC";
		}
		return "desconocido";
	}
	...
	//CUNDINAMARCA
	static String[] ciudadesCundinamarca = {"choconta","chocontá","macheta","manta","sesquile","sesquilé","suesca","tibirita",
	...
	static String[] ciudadesSantander = {"bucaramanga","aguada","albania","albania santander","aractoca","barbosa","barichara","barrancabermeja","betulia","cabrera",
			"california","aratoca","capitanejo","carcasi","charala","charalá","charta","cimitarra","concepcion","confines","contratacion",
